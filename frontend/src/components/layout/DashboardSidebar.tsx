...
export function DashboardSidebar() {
  ...
  const getNavigationForRole = (): NavSection[] => {
    switch (user.role) {
      case 'BUYER':
        return [
          {
        ...
        return [
          ...
          },
          {
            ...
            items: [
              ...
              {
                name: 'Pending Orders',
                href: '/suppliers/orders?status=pending',
                icon: (
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    >
                ...
                >
                  ...
                  {isSidebarOpen && (
                    <>
                      ...
                      {item.badge && (
                        <span className={`text-xs px-2 py-0.5 rounded-full ${item.badgeColor || 'bg-red-500'} text-white`}>
                          {item.badge}
                        </span>
                      )}
                    </>
      ...
      <div className="p-4 border-t border-gray-700 relative">
        <button
          ...
          className="w-full flex items-center gap-3 hover:bg-gray-700 rounded-lg p-2 transition-colors"
        >
        ...
        {userDropdownOpen && isSidebarOpen && (
          <div className="absolute bottom-full left-4 right-4 mb-2 bg-gray-800 rounded-lg shadow-2xl border border-gray-700 overflow-hidden">
            ...
            <button
              ...
              className="w-full text-left px-4 py-3 hover:bg-red-600 transition-colors text-sm border-t border-gray-700"
            >
              <div className="flex items-center gap-2">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
