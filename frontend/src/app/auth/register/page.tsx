...
export default function RegisterPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    password: '',
    confirmPassword: '',
    role: 'BUYER' as 'BUYER' | 'OWNER' | 'CONTRACTOR' | 'SUPPLIER' | 'AGENT' | 'ADMIN',
    phone: '',
    agreeToTerms: false,
  })
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-primary-50 flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Join Zimbabwe's trusted construction platform</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <select
                ...
                disabled={loading}
              >
                <option value="BUYER">Property Buyer / Home Builder</option>
